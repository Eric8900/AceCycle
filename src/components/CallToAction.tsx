...
const CallToAction = () => {
    ...
    return (
        <div className='flex justify-center items-center w-full my-32'>
            <div className="flex justify-center items-center relative drop-shadow-lg ring-1 ring-gray-300 w-[90%] sm:w-[70%] md:w-[65%] lg:w-[50%] overflow-hidden bg-white rounded-xl p-12">
                {/* Animated rows */}
