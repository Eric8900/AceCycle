...
const stats = [
  { value: <div className="text-4xl sm:text-5xl font-extrabold tracking-tighter"><NumberTicker value={330000000} className="text-green-800" />+</div>, label: "tennis balls produced annually" },
    ...
    <div className="flex flex-col justify-center items-center py-12 md:py-24">
      ...
      <div className="grid grid-cols-1 w-[80%] mt-[5%]">
        {stats.map((stat, index) => (
          <Card key={index} className="border-none shadow-none py-5">
